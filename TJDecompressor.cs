...
namespace TurboJpegWrapper
{
    ...
    public class TJDecompressor : IDisposable
    {
        ...
        public unsafe Bitmap Decompress(IntPtr jpegBuf, ulong jpegBufSize, PixelFormat destPixelFormat = PixelFormat.Format32bppArgb, TJFlags flags = TJFlags.FASTDCT)
        {
            if (_isDisposed)
                throw new ObjectDisposedException("this");
        ...
        /// <exception cref="ObjectDisposedException">Object is disposed and can not be used anymore</exception>
        /// <exception cref="NotSupportedException">Convertion to the requested pixel format can not be performed</exception>
        public unsafe Bitmap Decompress(byte[] jpegBuf, PixelFormat destPixelFormat = PixelFormat.Format32bppArgb, TJFlags flags = TJFlags.FASTDCT)
        {
            if (_isDisposed)
                throw new ObjectDisposedException("this");
