...
namespace TurboJpegWrapper
{
    static class TurboJpegImport
    {
        ...
        public static void Load(string directory, bool isthrowonplatformerrors = true)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(directory, "The directory '{directory}' does not exist.");
            }
            ...
            if (Environment.OSVersion.Platform == PlatformID.Win32NT)
            {
                ...
                if (!Directory.Exists(nativeLibrariesDirectory))
                {
                    ...
                    //throw new ArgumentOutOfRangeException(directory, "The directory '"+directory+"' does not contain a subdirectory for the current architecture. The directory '"+nativeLibrariesDirectory+"' does not exist.");
                }
